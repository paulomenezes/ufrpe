...
import br.ufrpe.conectada.adapters.CalendarEventAdapter;
import br.ufrpe.conectada.listeners.MainTitle;
import br.ufrpe.conectada.models.Course;
import br.ufrpe.conectada.models.Event;
...
import br.ufrpe.conectada.utils.MultipleDotSpan;
...
public class CalendarFragment extends Fragment {
    ...
    private br.ufrpe.conectada.models.Calendar mCalendar;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && mCalendarView != null) {
            ...
            br.ufrpe.conectada.models.Calendar calendar = Parcels.unwrap(savedInstanceState.getParcelable("events"));
            if (calendar != null) {
                mCalendar = calendar;
                loadEvents();
            }
            ...
            Call<br.ufrpe.conectada.models.Calendar> calendarCall = avaServices.getCalendarEvents(1, 1, getStart(), getEnd(),
                    events, Requests.FUNCTION_GET_CALENDAR_EVENTS, Session.getUser(getActivity()).getToken());

            calendarCall.enqueue(new retrofit2.Callback<br.ufrpe.conectada.models.Calendar>() {
                @Override
                public void onResponse(Call<br.ufrpe.conectada.models.Calendar> call, Response<br.ufrpe.conectada.models.Calendar> response) {
                ...
                @Override
                public void onFailure(Call<br.ufrpe.conectada.models.Calendar> call, Throwable t) {
                    t.printStackTrace();
                }
            });
        }
    ...
    private long getStart() {
        ...
        Calendar mycal = new GregorianCalendar(c.get(Calendar.YEAR), 1, 1);
        return mycal.getTimeInMillis() / 1000;
    }

    private long getEnd() {
        Calendar c = Calendar.getInstance();
        Calendar mycal = new GregorianCalendar(c.get(Calendar.YEAR) + 1, 12, 1);
        return mycal.getTimeInMillis() / 1000;
    }
